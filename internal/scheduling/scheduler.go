...
func handleCloudOffload(r *scheduledRequest) {
	...
	// ENRICO: tutte le richieste dirette al cloud saranno inoltrate al load balancer
	//         il cui indirizzo è specificato nel file di configurazione del nodo serverledge
